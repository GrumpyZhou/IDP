...
We use three different data set to validate our algorithm. The first is MNIST database of handwritten digits which contains 60,000 training examples and 10,000 testing examples. Each example is a black-white image in pixels of 28x28. The second is Moon.......
